...
train_stage=-10
tree_affix=_chain  # affix for tree directory, e.g. "a" or "b", in case we change the configuration.
tdnn_affix=_chain  #affix for TDNN directory, e.g. "a" or "b", in case we change the configuration.
